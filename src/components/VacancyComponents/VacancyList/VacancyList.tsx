...
const VacancyList = () => {
  const vacancies = useAppSelector((state) => state.vacancySlice.vacancy);
  ...
  if (!vacancies) {
    return (
      <h1 style={{marginLeft: '25%', borderBottom: '3px solid black',  width: '47%'}}>К сожалению, пока что вакансий нет</h1>
      );
  } else {
  return (
