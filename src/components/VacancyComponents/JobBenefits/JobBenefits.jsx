...
import team_icon from "../../../pages/Vacancy/images/team-icon.png";
import bonus_icon from "../../../pages/Vacancy/images/bonus-icon.png";
import self_realization_icon from "../../../pages/Vacancy/images/self-realization-icon.png";
import development_icon from "../../../pages/Vacancy/images/development-icon.png";
    ...
    <div id="mainJoboBenefits" className={style.main_job}>
      <div className={style.main_text}>
        ...
        <p className={style.main_description}>
          Pixell сегодня — это команда из более 500 человек и офисы по всему
